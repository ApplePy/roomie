...
void adduser(int uc, vector<people> ub, int tfi, vector<int> userList, int userBaseSize, string fni, string lni){
	people x(tfi, userList,userBaseSize,fni,lni);
	ub.push_back(x);
}
void main(){
	int userCounter(0);
	std::vector<people> userBase;
