        ...
        <div class="container" style="text-align:center">
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                   ...
                   <div ><form name="myForm" action="match.html" onsubmit="return validateForm()" method="post">
                    <p> Cleanliness:   
                   ...
                   <div >
                    ...
                    <label class="radio-inline"><input type="radio" name="optradio2" value = "Doesn't matter">Doesn't Matter</label>
                  </div>
                  <div>
